      ...
      <div class="contact-info-content">
        <div class="contact-info-item">
          ...
          <div class="content">
            ...
            <a href="tel://18123504001">812.350.4001</a>
          </div>
        </div>
        <div class="contact-info-item">
          <div class="icon">
        ...
        <div class="col-lg-12">
          ...
          >
            <div class="contact-map-area">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d201544.97214385078!2d-86.2920791654713!3d39.93041978938341!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8814ad973033fa1d%3A0x43b9095f5f7b38fc!2sCarmel%2C%20IN!5e0!3m2!1sen!2sus!4v1630540937037!5m2!1sen!2sus"
              ></iframe>
            </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group mb-0">
                      <button
                        ...
                        type="submit"
                      >
                        Submit Now <i class="icofont-long-arrow-right"></i>
                      </button>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    ...
    async writeToFirestore() {
      ...
      console.log(fName);
      const ref = fireDb.collection('mail').doc(fName);
      ...
      const mailDoc = {
        to: ['jared@supermilesbros.com'],
        message: {
          subject: fName + ' ' + 'New Contact Form',
          text:
            this.formData.comments + ' ' + fName + ' ' + this.formData.email,
        },
      };

      try {
        await ref.set(mailDoc);
      } catch (e) {
        console.log(e);
      }
